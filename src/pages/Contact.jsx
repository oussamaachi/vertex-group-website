...
export default function Contact() {
  ...
  return (
    <>
      ...
      <section ref={heroRef} className="section-padding bg-cream min-h-[80dvh]">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          {/* Left Column */}
          <div className="contact-anim">
            <span className="font-mono-brand text-xs text-moss/60 tracking-widest uppercase block mb-3">Contact</span>
            <h1 className="font-drama italic text-charcoal leading-tight mb-6" style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)' }}>
              Parlons de <span className="text-clay font-bold">votre projet.</span>
            </h1>

            <div className="space-y-6 mt-10">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 bg-moss/10 rounded-xl flex items-center justify-center flex-shrink-0 mt-0.5">
              ...
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 bg-moss/10 rounded-xl flex items-center justify-center flex-shrink-0 mt-0.5">
                  <Clock size={18} className="text-moss" />
                </div>
                <div>
            ...
            <div className="mt-10 p-5 bg-cream-dark rounded-2xl">
              <div className="font-mono-brand text-xs text-charcoal/40 space-y-1">
                <p>SIREN : 101 799 591 · RCS Créteil</p>
                <p>SAS à associé unique · Capital 1 000 €</p>
              </div>
            </div>
          </div>
          ...
          {/* Right Column - Form */}
          <div className="contact-anim">
            <form onSubmit={handleSubmit} className="bg-white rounded-container card-shadow p-8 space-y-5">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 bg-cream rounded-xl border border-moss/10 focus:border-moss/30 focus:outline-none transition-colors font-heading text-sm"
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  required
                  className="w-full px-4 py-3 bg-cream rounded-xl border border-moss/10 focus:border-moss/30 focus:outline-none transition-colors font-heading text-sm appearance-none"
                >
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows="4"
                  className="w-full px-4 py-3 bg-cream rounded-xl border border-moss/10 focus:border-moss/30 focus:outline-none transition-colors font-heading text-sm resize-none"
              ...
              >
                {submitted ? (
                  ...
                  <>
                    <span className="btn-slide rounded-xl"></span>
            ...
            <p className="text-center font-mono-brand text-xs text-charcoal/30 mt-4">
              28 Avenue des Pépinières, 94260 Fresnes · SIREN 101 799 591 · RCS Créteil
            </p>
          </div>
        </div>
      </section>
